...
public class WeeksAverage extends ConsumptionHttpRequest {

	public WeeksAverage(int week, int year){
		super.setRequestCode(week-1+"/"+year);
		super.setRequestType("week");
